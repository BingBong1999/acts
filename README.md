...
- **Commit 내역의 '20190942'(필자의 학번), 'hello', 'kyungwon Kim', 'BingBong1999', '김경원', 'user' 계정은 모두 본인임을 밝힙니다.**
...
### ***도메인 객체의 데이터 생성(C), 검색(R), 갱신(U), 삭제(D) 요청은 Controller에서 접수합니다.***
...
### ***사용자가 게시글을 생성/수정하면서 게시글의 대표 이미지를 설정할 경우***
